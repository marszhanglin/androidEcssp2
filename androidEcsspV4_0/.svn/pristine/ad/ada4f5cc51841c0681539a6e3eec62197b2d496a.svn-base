...
public class AsyDeptTreeActivity extends BaseActivity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        UiUtil.initTree("福建省政府", "root", "jfs/ecssp/mobile/pubCtr/getAsyDeptTree", postmap,
                R.layout.tree_data_item,R.id.tree_data_item_image, R.id.tree_data_item_text, 
                R.drawable.ic_launcher,R.drawable.ljwg_dw_gzrz_aqjj, 90,new AsyTreeAdapter.AsyTreeItemclick() {
                    @Override
