...
public class ResourvceOverItem extends ItemizedOverlay<OverlayItem> implements Overlay.Snappable {
     ...
     * @param context
     */
    public ResourvceOverItem(Drawable marker, Context context, MapView mapView, GeoPoint cPoint,
            ResourceItemInterface resourceItemInterface) {
    ...
    protected boolean onTap(int i) { 
        double distance = GpsUtil.getDistanceFromBaidu(mcenterPoint.getLatitudeE6() / 1E6,
