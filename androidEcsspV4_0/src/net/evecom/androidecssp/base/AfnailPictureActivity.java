...
public class AfnailPictureActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(null!=filebean.getFileURL()){
            displayImage(imageView, filebean.getFileURL());
        }
        if(null!=filebean.getFileby1()){
            HashMap<String, String> mparas = new HashMap<String, String>();
            mparas.put("fileid",filebean.getFileby1());
    ...
    public void delete(View v) {
        getDb().deleteById(FileManageBean.class, filebean.getFileID());
        Intent intent = new Intent();
        setResult(2, intent);
        finish();
    }
