...
import net.evecom.androidecssp.bean.xmlparser.UpdateInfo;
import net.evecom.androidecssp.bean.xmlparser.XmlParser;
...
public class SystemSetingActivity extends Activity {
     ...
     * @param v
     */
    public void maintabsettingsback(View v) {
        finish();
    }
     ...
     * @param v
     */
    public void maintabsettingcheckupdataapk(View v) {
        getVersionInfo();
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (code == 200) {// 请求成功
                        ...
                        updateInfo = (UpdateInfo) XmlParser.getUpdateInfo(is);
