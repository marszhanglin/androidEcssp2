...
public class AsyAreaTreeActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.area_asytree_at);
        HashMap<String, String> postmap = new HashMap<String, String>();
        listView = (ListView) findViewById(R.id.dept_asytree_ls);
        UiUtil.initTree("福建省政府", "350000", "jfs/ecssp/mobile/pubCtr/getAsyAreaTree", postmap, R.layout.tree_data_item,
                R.id.tree_data_item_image, R.id.tree_data_item_text, R.drawable.tree_node, R.drawable.ljwg_dw_gzrz, 90,
                new AsyTreeAdapter.AsyTreeItemclick() {
                    @Override
